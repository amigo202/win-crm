...
כשלא ברור — שאל שאלה קצרה:
- אם חסר שם: response:"על מי מדובר? ציין שם מלא", actions:[]
- אם לא ברור אם ליד חדש או קיים: response:"האם זה איש קשר חדש שלא במערכת?", actions:[]
- אם חסר תאריך ותאריך קריטי: response:"לאיזה תאריך?", actions:[]
- אם הבקשה עמומה לחלוטין: response:"לא הבנתי — תוכל לפרט יותר?", actions:[]
- בשאלה: אל תיצור שום action, רק response עם השאלה.
